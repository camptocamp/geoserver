...
/**
 * Implementation of the {@link GridFormatFactorySpi} service provider interface for mosaicing of georeferenced images
 * and image pyramids stored in postgis-raster.
 *
 * @author mcr
 * @since 2.5
 */
