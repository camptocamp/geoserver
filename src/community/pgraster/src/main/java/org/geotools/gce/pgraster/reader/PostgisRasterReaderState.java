...
public class PostgisRasterReaderState {
    ...
    private GeneralBounds requestedEnvelopeTransformed = null;

    private GeneralBounds requestedEnvelopeTransformedExpanded = null;
    ...
    public BufferedImage getEmptyImage(int width, int height) {
        ...
        BufferedImage emptyImage = new BufferedImage(width, height, PostgisRasterReaderState.DEFAULT_IMAGE_TYPE);
        ...
        if (outputTransparentColor != null) {
            emptyImage = new RenderedImageAdapter(ImageUtilities.maskColor(outputTransparentColor, emptyImage))
                    .getAsBufferedImage();
        }
        return emptyImage;
    }
    ...
    public void setRequestedEnvelope(GeneralBounds requestedEnvelope) {
        this.requestedEnvelope = requestedEnvelope;
    }

    public GeneralBounds getRequestedEnvelopeTransformed() {
        return requestedEnvelopeTransformed;
    }

    public void setRequestedEnvelopeTransformed(GeneralBounds requestedEnvelopeTransformed) {
        this.requestedEnvelopeTransformed = requestedEnvelopeTransformed;
    }

    public GeneralBounds getRequestedEnvelopeTransformedExpanded() {
        return requestedEnvelopeTransformedExpanded;
    }

    public void setRequestedEnvelopeTransformedExpanded(GeneralBounds requestedEnvelopeTransformedExpanded) {
