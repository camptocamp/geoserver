...
public class DBDialect {
    ...
    protected String getUnregisterSpatialStatement(String tn) {
        return "select DropGeometryColumn('" + tn + "','" + getConfig().getGeomAttributeNameInSpatialTable() + "')";
    }
    ...
    String getCreateTileTableStatement(String tableName) throws Exception {
        ...
        statement +=
                (",CONSTRAINT " + tableName + "_PK PRIMARY KEY(" + getConfig().getKeyAttributeNameInTileTable());
        statement += "))";
    ...
    protected String getCreateSpatialTableStatement(String tableName) throws Exception {
        ...
        statement +=
                (",CONSTRAINT " + tableName + "_PK PRIMARY KEY(" + getConfig().getKeyAttributeNameInSpatialTable());
        statement += "))";
