...
public class PostgresJDBCResourceStoreIT extends AbstractJDBCResourceStoreTest {
    ...
    public static @ClassRule PostgreSQLContainer<?> container = new PostgreSQLContainer<>(POSTGRES_TEST_IMAGE);

    public @Rule PostgresContainerTestSupport containerSupport = new PostgresContainerTestSupport(container);
